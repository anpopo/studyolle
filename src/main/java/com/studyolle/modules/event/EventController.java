...
public class EventController {
    ...
    public void eventInitBinder(WebDataBinder webDataBinder) {
    ...
    public String newEventSubmit(@CurrentUser Account account, @PathVariable String path, Model model,
                                 @Valid EventForm eventForm, Errors errors, RedirectAttributes redirectAttributes) {
        Study study = studyService.getStudyToUpdateStatus(account, path);
    ...
    public String updateEventForm(@CurrentUser Account account, @PathVariable String path, @PathVariable("id") Event event,
                                  Model model) {
